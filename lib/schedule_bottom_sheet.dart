    ...
    return GestureDetector(
      ...
      child: FutureBuilder<Schedule>(
          ...
          builder: (context, snapshot) {
            ...
            // Future가 실행이 되고 값이 있는데 단 한 번도 startTime이 세팅이 되지 않았을 때
...
class _Contents extends StatelessWidget {
  ...
  const _Contents({required this.onSaved, required this.initialValue, Key? key})
      : super(key: key);
